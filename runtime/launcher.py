...
from runtime.bootstrap import BootstrapError, build_app_container
...
from runtime.runtime_config import RuntimeConfig, load_system_config, save_system_config
...
def _build_runtime_config(profile_name: str, overrides: dict[str, Any], safe_mode: bool) -> RuntimeConfig:
    defaults = _load_defaults(PROJECT_ROOT / 'shared' / 'defaults.yaml')
    system_config = _load_system_config()
...
async def main(overrides: Optional[dict[str, Any]] = None) -> int:
    ...
    from runtime.main import start_engine
