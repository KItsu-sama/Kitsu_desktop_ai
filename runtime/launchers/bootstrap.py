...
from runtime.config.profiles import HardwareProfile, select_profile
from runtime.config.runtime_config import RuntimeConfig
from shared.flags.capability_flags import CapabilityFlags
from runtime.infrastructure.container import get_container, ServiceLifetime
...
class ServiceRegistry:
    ...
    def register_core_services(container) -> None:
        ...
        def create_health_monitor():
            ...
            return HealthMonitor(event_bus=event_bus, orchestrator=orchestrator, clock_service=clock_service, container=container)
