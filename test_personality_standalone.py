#!/usr/bin/env python
"""
Test personality enhancements by importing the file directly.
"""
import sys
import importlib.util

# Load the emotion_config module directly without going through __init__.py
spec = importlib.util.spec_from_file_location(
    "emotion_config",
    r"d:\Du lieu o C\kitsu_desktop_ai\domain\personality\emotion_config.py"
)
pconf = importlib.util.module_from_spec(spec)
spec.loader.exec_module(pconf)
...
print("\n8️⃣  Configuration validation completed successfully at module import:")
