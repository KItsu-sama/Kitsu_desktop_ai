...
=====================================
This is the "background worker" that makes Kisu smarter as you use her.
...
class LearningLoop:
    """
    Background learning system that improves Kisu's responses over time.
