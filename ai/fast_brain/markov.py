...
Role: It stores the state machine for words. If the user says "A," what is the probability kitsu says "B"? It's perfect for the "Hai! -> Hai!" spam loop because it tracks the transition frequency.
"""
...
class MarkovChain:
    ...
    def __init__(self, order: int = 2):
        ...
        # Learning data
        self.conversation_history: List[Tuple[str, str]] = []  # (user_input, kitsu_response)
        
        # Spam detection
        self.spam_patterns: Dict[str, int] = defaultdict(int)
        self.spam_threshold = 3  # Consecutive repeats considered spam
    
    def add_transition(self, user_input: str, kitsu_response: str) -> None:
        """
        ...
        response_tokens = self._tokenize(kitsu_response.lower())
        
        # Add to conversation history
        self.conversation_history.append((user_input, kitsu_response))
...
def add_conversation(user_input: str, kitsu_response: str) -> None:
    """
    ...
    Args:
        ...
        kitsu_response: Kitsu's response
    """
    markov_chain.add_transition(user_input, kitsu_response)
